...
@section('title', isset($item) ? 'Edit Inventory Item' : 'Add Inventory Item')
...
<div class="card">
    <div class="card-body">
        <form action="{{ isset($item) ? route('admin.inventory.update', $item->id) : route('admin.inventory.store') }}" method="POST">
            @csrf
            @if(isset($item))
                @method('PUT')
            @endif
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="stock_quantity" id="stock_quantity" class="form-control @error('stock_quantity') is-invalid @enderror"
                           value="{{ old('stock_quantity', $item->stock_quantity ?? 0) }}" min="0" required>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="minimum_stock" id="minimum_stock" class="form-control @error('minimum_stock') is-invalid @enderror"
                           value="{{ old('minimum_stock', $item->minimum_stock ?? 0) }}" min="0" required>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-1"></i> {{ isset($item) ? 'Update Item' : 'Create Item' }}
                </button>
