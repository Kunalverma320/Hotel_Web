...
<form action="{{ route('admin.hotels.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="tagline" id="tagline" class="form-control" value="{{ old('tagline') }}" placeholder="e.g., Where luxury meets comfort">
                        </div>
                        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3"><label class="form-label">State</label><input type="text" name="state" class="form-control" value="{{ old('state') }}"></div>
                        <div class="col-md-3"><label class="form-label">Country</label><input type="text" name="country" class="form-control" value="{{ old('country') }}"></div>
                        <div class="col-md-3"><label class="form-label">Zipcode</label><input type="text" name="zipcode" class="form-control" value="{{ old('zipcode') }}"></div>
                        <div class="col-md-4">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" step="any" name="latitude" class="form-control" value="{{ old('latitude') }}" placeholder="e.g., 28.6139">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Longitude</label>
                            <input type="number" step="any" name="longitude" class="form-control" value="{{ old('longitude') }}" placeholder="e.g., 77.2090">
                        </div>
                        <div class="col-12">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="cancellation_policy" class="form-control" rows="4" placeholder="Enter cancellation policy details...">{{ old('cancellation_policy') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="meta_keywords" class="form-control" value="{{ old('meta_keywords') }}" placeholder="hotel, luxury, accommodation (comma separated)">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="tab-pane fade" id="tab-amenities">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @else
                        <p class="text-muted">No amenities available. Create amenities first.</p>
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="mt-4 d-flex gap-2">
        <button type="submit" class="btn btn-primary"><i class="ri-save-line me-1"></i> Save Hotel</button>
