...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0"><i class="fas fa-university me-2"></i>Bank Book</h4>
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('admin.finance.bankbook') }}" class="row g-3">
            <div class="col-md-4">
            ...
            <div class="col-md-4 d-flex align-items-end">
                ...
                <a href="{{ route('admin.finance.bankbook') }}" class="btn btn-outline-secondary">Reset</a>
            </div>
        </form>
    </div>
</div>
